...
const StatCounter: React.FC<StatCounterProps> = ({ value, suffix, title }) => {
  ...
  return (
    <div className="text-center" ref={countRef}>
      <div className="text-4xl md:text-5xl font-bold text-brand-600 mb-2">{count}{suffix}</div>
...
const Benefits: React.FC = () => {
  const partners = [
    { name: 'AWS', logo: 'https://d0.awsstatic.com/logos/powered-by-aws.png' },
    { name: 'Microsoft Azure', logo: 'https://upload.wikimedia.org/wikipedia/commons/f/fa/Microsoft_Azure.svg' },
    { name: 'SentinelOne', logo: 'https://assets.brandfetch.io/idW8PNv29Z/idUZkVxZVY.svg' },
    { name: 'Dell', logo: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Dell_logo_2016.svg' },
    { name: 'Lenovo', logo: 'https://download.lenovo.com/lenovo/logo/lenovo-logo-red.svg' },
    { name: 'HP', logo: 'https://www.hp.com/content/dam/sites/worldwide/hp-logo.svg' },
    { name: 'Palo Alto Networks', logo: 'https://www.paloaltonetworks.com/etc/clientlibs/clean/imgs/pan-logo-badge-blue.svg' },
    ...
    <section className="py-20">
      <div className="container mx-auto px-4 md:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-600 text-lg">We have a proven track record of delivering exceptional IT services and solutions to businesses across industries.</p>
        </div>
