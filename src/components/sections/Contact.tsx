        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Whether you're looking for a complete IT overhaul, a specific solution, or just want to learn more about our services, our team is ready to help.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Card className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  <a href="tel:+13127259197" className="hover:text-blue-600 transition-colors">
                    (312) 725-9197
                  </a>
                </p>
              </div>
            ...
            <Card className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  <a href="mailto:info@azophi.com" className="hover:text-blue-600 transition-colors">
                    info@azophi.com
                  </a>
                </p>
              </div>
